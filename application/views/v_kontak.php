...
<html class="no-js">
	...
	<title>Perdana Trans | Kontak</title>
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						...
						<li><i class="icon-phone"></i>+62 821-3841-4008</li>
						<li><i class="icon-envelope"></i><a href="#">admin@perdana-trans.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.perdana-trans.com</a></li>
					</ul>
				</div>
